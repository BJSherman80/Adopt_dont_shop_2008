...
shelter_2 = Shelter.create(name: 'Critters Galore', address: '222 22nd Ave.', city: 'Denver', state: 'CO', zip: 82222)
shelter_3 = Shelter.create(name: 'Fuzzy Friends', address: '444 44th Ave.', city: 'Denver', state: 'CO', zip: 84444)
